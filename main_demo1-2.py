...
def all_main_demo2():
    ...
    world_traject_point = []
    before_first_point = image_to_world([traject_point_with_height[0][0], traject_point_with_height[0][1], 400], 0, 0, 0, 600, 600, 430, 430)
    world_traject_point.append(before_first_point)
    for i in traject_point_with_height:
        world_traject_point.append(image_to_world(i, 0, 0, 0, 600, 600, 430, 430))
    return(world_traject_point)

# print(all_main_demo2())
